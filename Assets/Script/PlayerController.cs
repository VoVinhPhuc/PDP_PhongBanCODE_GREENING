...
public class PlayerController : MonoBehaviour
{
    ...
    [Header("Inventory")]
    public int seedCount = 0; // Số lượng hạt đang có
    ...
    // --- HÀM MỚI: ĐỂ Ô ĐẤT GỌI KHI MUỐN TRỪ HẠT ---
    public bool TryUseSeed()
    {
        if (seedCount > 0)
        {
            ...
            return true; // Báo là "OK, đã dùng hạt thành công"
        }
        return false; // Báo là "Hết hạt rồi"
    }
}